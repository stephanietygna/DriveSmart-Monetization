...
for line in log_lines:
    ...
    if data:
        ...
        if key == 'Direção':
            current_data['Direção'] = value
        elif key == 'Velocidade (MK2)':
            current_data['Velocidade'] = value
        elif key == 'Curva brusca':
        ...
        if current_data['Data'] and current_data['Hora'] and current_data['Direção'] and current_data['Velocidade'] and current_data['Curva Brusca'] and current_data['Créditos']:
